...
export function isAdmin(_session: Session | null): boolean {
  // Never trust localStorage/console. Admin UI comes only from /api/admin/status.
  return false;
}

export function isCreator(_session: Session | null): boolean {
  return false;
}
